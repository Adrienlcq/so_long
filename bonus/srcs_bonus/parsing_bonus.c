...
/*   Updated: 2022/05/25 16:29:30 by adlecler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	char_map(t_game *game, char *file)
{
	...
	while (game->x <= game->x_max)
	{
		...
		{
			game->d++;
			game->dofi[0] = game->y; //recupere la position y de dofi
			game->dofi[1] = game->x; //recupere la position x de dofi
...
// check rien d'autre que 0,1,E,C,P,D
