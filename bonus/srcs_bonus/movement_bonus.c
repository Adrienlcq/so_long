...
/*   Updated: 2022/05/25 16:41:47 by adlecler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_up(t_game *game)
{
	...
	else if (game->player[0] - 1 == game->dofi[0] && game->player[1] == game->dofi[1])
	{
		game->player[0]--;
...
void	ft_left(t_game *game)
{
	...
	else if (game->player[0] == game->dofi[0] && game->player[1] - 1 == game->dofi[1])
	{
		game->player[1]--;
		printf("U were caught by Dofi\n");
		//free
...
void	ft_right(t_game *game)
{
	...
	else if (game->player[0] == game->dofi[0] && game->player[1] == game->dofi[1] + 1)
	{
		game->player[1]++;
		printf("U were caught by Dofi\n");
		//free
